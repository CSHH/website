...
class MovieRepository extends WikiRepository
{
    /** @var ITranslator */
    private $translator;
    ...
    {
        return $this->dataAccess->getAllForPage($page, $limit, Entities\WikiEntity::TYPE_MOVIE, $activeOnly);
    }
    ...
    {
        return $this->dataAccess->getAllByTag($tag, Entities\WikiEntity::TYPE_MOVIE);
    }
    ...
    {
        return $this->dataAccess->getByTagAndName($tag, $name, Entities\WikiEntity::TYPE_MOVIE);
    }
    ...
    {
        return $this->dataAccess->getByTagAndSlug($tag, $slug, Entities\WikiEntity::TYPE_MOVIE);
    }
    ...
    {
        return $this->dataAccess->getAllByTagForPage($page, $limit, $tag, Entities\WikiEntity::TYPE_MOVIE, $activeOnly);
    }
    ...
    {
        return $this->dataAccess->getAllByUserForPage($page, $limit, $user, Entities\WikiEntity::TYPE_MOVIE);
    }
    ...
    {
        return $this->dataAccess->getAllInactiveForPage($page, $limit, Entities\WikiEntity::TYPE_MOVIE);
    }

...
class GameRepository extends WikiRepository
{
    /** @var ITranslator */
    private $translator;
    ...
    public function __construct(
        ...
        EntityManager $em,
        Caching\GameTagSectionCache $tagCache,
    ...
    public function update(
        ...
        $this->backlinkRepository->create($ent, $oldTag, $oldSlug, 'hry');
    ...
    {
        return $this->dataAccess->getAllForPage($page, $limit, Entities\WikiEntity::TYPE_GAME, $activeOnly);
    }
    ...
    {
        return $this->dataAccess->getByTagAndName($tag, $name, Entities\WikiEntity::TYPE_GAME);
    }
    ...
    {
        return $this->dataAccess->getByTagAndSlug($tag, $slug, Entities\WikiEntity::TYPE_GAME);
    }
    ...
    {
        return $this->dataAccess->getAllByTagForPage($page, $limit, $tag, Entities\WikiEntity::TYPE_GAME, $activeOnly);
    }
    ...
    {
        return $this->dataAccess->getAllByUserForPage($page, $limit, $user, Entities\WikiEntity::TYPE_GAME);
    }
    ...
    {
        return $this->dataAccess->getAllActive(Entities\WikiEntity::TYPE_GAME);
    }
    ...
    {
        return $this->dataAccess->getAllInactiveForPage($page, $limit, Entities\WikiEntity::TYPE_GAME);
    }
    ...
    {
        return $this->dataAccess->getAllInactiveByTagForPage($page, $limit, $tag, Entities\WikiEntity::TYPE_GAME);
    }
    ...
    {
        return $this->dataAccess->getAllTags(Entities\WikiEntity::TYPE_GAME);
    }

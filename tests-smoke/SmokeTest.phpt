...
class SmokeTest extends Tester\TestCase
{
    ...
    public function getParams()
    {
        return [
            ...
            ['/uzivatelska-sekce/filmy/drafty',        302],
            ['/uzivatelska-sekce/filmy/drafty/detail', 302],
            ['/uzivatelska-sekce/filmy/formular',      302],
            ['/uzivatelska-sekce/filmy',               302],
            ['/uzivatelska-sekce/filmy/1',             302],
            ['/uzivatelska-sekce/knihy/drafty',        302],
            ['/uzivatelska-sekce/knihy/drafty/detail', 302],
